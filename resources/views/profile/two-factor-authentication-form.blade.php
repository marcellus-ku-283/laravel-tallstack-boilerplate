<x-action-section>
    ...
    <x-slot name="description">
        <span class="text-justify">{{ __('Add additional security to your account using two factor authentication.') }}</span>
    </x-slot>
        ...
        <div class="flex flex-col justify-between">
            ...
            @if ($this->enabled)
                @if ($showingQrCode)
                    ...
                    <div class="flex justify-center max-w-xl mt-4 text-sm text-gray-600 md:justify-start">
                    ...
                    @if ($showingConfirmation)
                        <div class="flex flex-col justify-center mt-4 md:justify-start">
                            <x-label for="code" value="{{ __('Code') }}" />

                            <x-input id="code" type="text" name="code"
                                class="block mt-1 lg:w-1/2 md:w-1/2 sm:w-full" inputmode="numeric" autofocus
